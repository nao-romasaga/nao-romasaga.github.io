                ...
                for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                    ...
                    if (isAbsolute) {
                        ...
                        if (context.isRtl) {
                            ...
                            var size = (seg.lastCol === 6) ? 0 : (framePositions.rights[1] - framePositions.rights[0]) * 3/5;
                            left = 0;
                            right = framePositions.rights[seg.firstCol] - framePositions.rights[seg.lastCol] + size;
                            //[120 - 240 = -120]
                        }
                    }
                    else {
                    ...
                    */
                    nodes.push(createElement("div", { className: 'fc-daygrid-event-harness2' + (isAbsolute ? ' fc-daygrid-event-harness-abs' : ''), key: instanceId, 
